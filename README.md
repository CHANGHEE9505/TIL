...
| 항목 | 내용 |
| --- | --- |
| **소개** | '운해 보러갈래?'는 등산 관심이 높아진 MZ세대를 위한 운해 명소 추천 앱입니다. React Native와 Firebase를 기반으로, 운해 관측 확률과 100대 명산 정보를 제공합니다. 사용자들은 자신의 경험을 인증샷으로 공유하며 소통할 수 있습니다. |
...
| 항목 | 내용 |
| --- | --- |
| **소개** | '펫미팅'은 반려동물의 사회성 증진과 반려인 간의 교류를 위한 소셜 앱입니다. 바쁜 반려인을 위한 '대리 산책' 커뮤니티, 자연스러운 만남을 주선하는 '산책 중 만남' 기능을 제공합니다. 또한 '반려동물 소개팅'으로 새로운 친구를 찾아주며 건강한 반려 생활을 지원합니다. |
