...
![디스크확인](./img/파티션img/6.png)
---
p: 파티션확인 n 새로운 파티션 추가 d 파티션지우기 w저장하고 나가기 q 저장하지 않고 나가기
...
시스템 부팅 시마다 **자동으로 마운트**되도록 설정하는 과정
...
- autofs는 동적으로 자동 마운트하는 도구  
- 종료 후에도 자동 마운트를 확실히 하고 싶을 때 사용
